...
mod test {
        ...
        mod public {
            ...
            fn test_rsa_pem() {
                Decoder::<Public>::new()
                    ...
                    .decode(include_bytes!("../test/rsa.pub.pem"))
                    .unwrap()
                    .rsa()
                    .unwrap();
            }
            ...
            fn test_rsa_pem_pkcs1() {
                Decoder::<Public>::new()
                    ...
                    .decode(include_bytes!("../test/rsa.pub.pkcs1.pem"))
                    .unwrap()
                    .rsa()
                    .unwrap();
            }
    ...
    mod encoder {
        ...
        mod public {
            ...
            #[test]
            fn test_rsa_pem() {
                let expected = include_bytes!("../test/rsa.pub.pem");
        ...
        mod private {
            ...
            #[test]
            fn test_rsa_pem() {
                let expected = include_bytes!("../test/rsa.pkcs1.pem");
